...
def load_seq(file_path):
    ...
    seq2_seq = df['seq2']
    #lbs = df['label']
    return seq1_seq, seq2_seq


def df2enrie(file_path, save_path, seq1_out_txt, seq2_out_txt, seq1_out_fasta, seq2_out_fasta):
    seq1_seq, seq2_seq = load_seq(file_path)
    names = range(len(seq1_seq))
...
if __name__ == "__main__":
    ...
    df2enrie(args.file_path, args.save_path, args.seq1_out_txt, args.seq2_out_txt, 
             args.seq1_out_fasta, args.seq2_out_fasta)
